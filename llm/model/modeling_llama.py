...
from llm.model.configuration_wmark_gpt import LlamaConfig
from llm.model.multiway import MultiwayNetwork
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.layers = nn.ModuleList(
            [LlamaDecoderLayer(config) for layer_idx in range(config.num_hidden_layers)]
        )
